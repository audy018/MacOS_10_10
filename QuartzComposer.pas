...
{$include quartzcomposer/UndefinedTypes.inc}

{$define TYPES}
{$include quartzcomposer/Sources.inc}
{$undef TYPES}
...
{$include quartzcomposer/InlineFunctions.inc}
