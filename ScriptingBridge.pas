...
{$include scriptingbridge/UndefinedTypes.inc}

{$define TYPES}
{$include scriptingbridge/Sources.inc}
{$undef TYPES}
...
{$include scriptingbridge/InlineFunctions.inc}
