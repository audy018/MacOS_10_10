...
{$include screensaver/UndefinedTypes.inc}

{$define TYPES}
{$include screensaver/Sources.inc}
{$undef TYPES}
...
{$include screensaver/InlineFunctions.inc}
