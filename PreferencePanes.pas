...
{$include preferencepanes/UndefinedTypes.inc}

{$define TYPES}
{$include preferencepanes/Sources.inc}
{$undef TYPES}
...
{$include preferencepanes/InlineFunctions.inc}
