...
{$include quartzfilters/UndefinedTypes.inc}

{$define TYPES}
{$include quartzfilters/Sources.inc}
{$undef TYPES}
...
{$include quartzfilters/InlineFunctions.inc}
