...
{$include instantmessage/UndefinedTypes.inc}

{$define TYPES}
{$include instantmessage/Sources.inc}
{$undef TYPES}
...
{$include instantmessage/InlineFunctions.inc}
