...
{$include installerplugins/UndefinedTypes.inc}

{$define TYPES}
{$include installerplugins/Sources.inc}
{$undef TYPES}
...
{$include installerplugins/InlineFunctions.inc}
