...
{$include medialibrary/UndefinedTypes.inc}

{$define TYPES}
{$include medialibrary/Sources.inc}
{$undef TYPES}
...
{$include medialibrary/InlineFunctions.inc}
