...
{$include iobluetooth/UndefinedTypes.inc}

{$define TYPES}
{$include iobluetooth/Sources.inc}
{$undef TYPES}
...
{$include iobluetooth/InlineFunctions.inc}
