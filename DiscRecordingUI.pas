...
{$include discrecordingui/UndefinedTypes.inc}

{$define TYPES}
{$include discrecordingui/Sources.inc}
{$undef TYPES}
...
{$include discrecordingui/InlineFunctions.inc}
