...
{$include servicemanagement/UndefinedTypes.inc}

{$define TYPES}
{$include servicemanagement/Sources.inc}
{$undef TYPES}
...
{$include servicemanagement/InlineFunctions.inc}
