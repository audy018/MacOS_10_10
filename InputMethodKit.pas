...
{$include inputmethodkit/UndefinedTypes.inc}

{$define TYPES}
{$include inputmethodkit/Sources.inc}
{$undef TYPES}
...
{$include inputmethodkit/InlineFunctions.inc}
