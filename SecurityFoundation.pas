...
{$include securityfoundation/UndefinedTypes.inc}

{$define TYPES}
{$include securityfoundation/Sources.inc}
{$undef TYPES}
...
{$include securityfoundation/InlineFunctions.inc}
