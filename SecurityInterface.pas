...
{$include securityinterface/UndefinedTypes.inc}

{$define TYPES}
{$include securityinterface/Sources.inc}
{$undef TYPES}
...
{$include securityinterface/InlineFunctions.inc}
