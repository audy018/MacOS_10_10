...
{$include syncservices/UndefinedTypes.inc}

{$define TYPES}
{$include syncservices/Sources.inc}
{$undef TYPES}
...
{$include syncservices/InlineFunctions.inc}
