...
{$include discrecording/UndefinedTypes.inc}

{$define TYPES}
{$include discrecording/Sources.inc}
{$undef TYPES}
...
{$include discrecording/InlineFunctions.inc}
